        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_Clients_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 2, 4, 1, "Chicago Loop Apartment", 120.00m, "chicago-apartment.jpg" },
                    { 2, 1, 1, 2, 2, "New York Studio", 150.00m, "ny-studio.jpg" },
                    { 3, 2, 3, 6, 3, "Boston Townhouse", 200.00m, "boston-townhouse.jpg" }
                });
